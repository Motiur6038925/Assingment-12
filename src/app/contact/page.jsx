...
function page() {
  ...
  return (
    <div className=" bg-gradient-to-b from-purple-600 to-indigo-700    w-full flex items-center justify-center my-12">
    ...
    //           className="text-base focus:outline-none focus:ring-1 p-2 focus:ring-offset-1 focus:ring-white hover:text-gray-300 font-medium mr-10 leading-4 text-white"
    //         ></p>
    //         <button className="text-base font-medium leading-none text-indigo-700 py-4 px-5 bg-white rounded focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-white hover:bg-gray-300"></button>
    //       </div>
